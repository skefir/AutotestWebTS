...
import { CalendarEventInfoTab, Currencies, CurrencyFilter, DateFilterOptions, DateFilterValues, EventInfoTab, Importance, ImportanceFilterOption } from '../src/data';
...
test.describe('Check calendar functional', () => {
    test('Check calendar filter', async ({ page }) => {
        ...
        await calendarListPage.setImportanceFilter(new ImportanceFilterOption(Importance.MEDIUM))
